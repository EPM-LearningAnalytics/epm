...
def main():
    """
    present the entire sources and codes for the application.
    The main sections consists of `Home`, `Log In`, `Sign Up`, and `About`.
...
def page_review_alert(username):
    """
    give a student information about which sesssions he/she is recommended
    to review to boost their final exam grades.
...
def page_grouping_assistant():
    """
    give a instructor a grouping guideline for team activity
